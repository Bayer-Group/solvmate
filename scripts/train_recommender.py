...
if __name__ == "__main__":
    ...
    if args.paper:
        ...
        rcf.train_and_eval_recommenders(
            ...
            job_name="PAPER_FEATURES_BAYER_OOD",
            only_source=None,
            eval_on_ood=True,
        )
        info("DONE.")
        ...
        rcf.train_and_eval_recommenders(
            ...
            nova_as_ood=True,
            save_recommender=False,
            job_name="PAPER_FEATURES_NOVA_OOD",
            only_source=None,
            eval_on_ood=True,
        )
        info("DONE.")
        ...
        rcf.train_and_eval_recommenders(
            ...
            nova_as_ood=False,
            save_recommender=False,
            job_name="PAPER_FEATURES_BUTINA",
            only_source=None,
            eval_on_ood=False,
        )
        info("DONE.")
        ...
        rcf.train_and_eval_recommenders(
            ...
            nova_as_ood=True,
            save_recommender=False,
            job_name="PAPER_FEATURES_SOLVENT_CV",
            only_source=None,
            eval_on_ood=False,
        )
        info("DONE.")
